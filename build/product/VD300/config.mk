...
export FW_BOOT_VERSION = 4.0.1.1
else
export FW_BOOT_VERSION = 0.0.1.1
endif
else
...
#export FW_VERSION = $(shell cat ./product/VD300/jffs2/.pid | cut -b 101-104)_$(FW_EXTRA_VERSION)
export FW_VERSION = $(shell cat $(PID) | cut -b 101-104)_$(FW_EXTRA_VERSION)
else
export FW_VERSION = $(shell cat ./product/VD300/jffs2/.pid | cut -b 101-104)
endif
else
...
export CONFIG_SUPPORT_ZIGBEE = 1
export CONFIG_SUPPORT_USB_SERIAL_CP210X=1
export CONFIG_SUPPORT_USB_SERIAL_FTDI_SIO=1
