...
export FW_EXTRA_VERSION = 06
endif
ifeq ($(SC_CUSTOMER), VFIN)
export FW_BOOT_VERSION = 0.0.1.1
else
ifeq ($(BRCM_416), 1)
ifeq ($(SC_NAND_FLASH_SIZE), 256)
export FW_BOOT_VERSION = 3.0.0.0
else
export FW_BOOT_VERSION = 0.0.1.1
endif
else
export FW_BOOT_VERSION = 4.0.1.0
endif
endif
ifeq ($(ROOTFSTYPE), jffs2) 
ifneq ($(FW_EXTRA_VERSION), )
export FW_VERSION = $(shell cat ./product/VOX30/jffs2/.pid | cut -b 101-104)_$(FW_EXTRA_VERSION)
else
export FW_VERSION = $(shell cat ./product/VOX30/jffs2/.pid | cut -b 101-104)
endif
else
...
export CONFIG_SAFE_NETWORK = 1

export CONFIG_SUPPORT_WEB_PRIVOXY = 1
export SC_WIFI = 1
export SC_WSC = 0
...
export CONFIG_SUPPORT_IPSEC_CLIENT = 1
...
export CONFIG_SUPPORT_PASSWORD_PROTECTION = 1
...
export CONFIG_SUPPORT_FAP = 0
export CONFIG_SUPPORT_ATTACK_ALERT = 0
export CONFIG_SUPPORT_ENCRYPTION_AES = 1
export CONFIG_SUPPORT_DEBUG = 1
export CONFIG_SUPPORT_FON = 1
export CONFIG_SUPPORT_L2TP = 1
export CONFIG_SUPPORT_OPENVPN = 0
export CONFIG_SUPPORT_RUNNER = 1
export CONFIG_SUPPORT_WIFI_MSSID = 1
export CONFIG_SUPPORT_WIFI_WDS = 0
export CONFIG_USE_DNSMASQ = 0
export CONFIG_USE_DNSMASQ_IPV6_ONLY = 1
#support web api
...
export CONFIG_SUPPORT_BANDSTEERING = 1
#support pcpd
...
export CONFIG_SUPPORT_SJCL_ENCRYPT = 1
export CONFIG_SUPPORT_SEC_BOOT = 1

export VOX30_SFP = 1
export VOX_LED_SPEC = 1
export SFP_LIB_DEBUG = 0
#support NAT loopback
export CONFIG_SUPPORT_NATLOOPBACK = 1
export CONFIG_PPP_SUPPORT_PADM_PADN = 1
export CONFIG_SUPPORT_PACKAGE = 0
export CONFIG_SUPPORT_TR157 = 0
export CONFIG_SUPPORT_LCM = 0
export CONFIG_SUPPORT_PLUME = 0
export CONFIG_SUPPORT_BINARY_PROTECT = 0
export CONFIG_SUPPORT_FWA = 0
export CONFIG_SUPPORT_HA = 0
export CONFIG_SUPPORT_MQTT = 0
export CONFIG_SUPPORT_FORCE_SSID = 0
export CONFIG_SUPPORT_TR232 = 0
