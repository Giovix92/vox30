...
#ifdef __SC_BUILD__
    unsigned int       adslPrevShowTimeIntervals;
    unsigned int       adslSinceLinkTillNowTimeIntervals; /*different from adslSinceLinkTimeElapsed, adslSinceLinkTillNowTimeIntervals will continue increasing if DSL link is down*/
#endif
} adslPerfDataEntry;
