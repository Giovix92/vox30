	...
	.file	"bounds.c"
@ GNU C89 (Buildroot 2016.02) version 5.3.0 (arm-buildroot-linux-gnueabi)
...
@ -isysroot /opt/toolchains/crosstools-arm-gcc-5.3-linux-4.1-glibc-2.24-binutils-2.25/usr/arm-buildroot-linux-gnueabi/sysroot
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm -D CC_HAVE_ASM_GOTO
@ -D __SC_BUILD__ -D VOX30 -D VFIT -D SC_NAND_FLASH_SIZE=256
@ -D CONFIG_SUPPORT_SPI_FIREWALL -D CONFIG_SUPPORT_UBUS
@ -D CONFIG_SUPPORT_IPERF -D CONFIG_BRCM_SUPPORT_VMUX -D CONFIG_SUPPORT_FON
@ -D VOX30_SFP -D VOX_LED_SPEC -D CONFIG_CRASH_LOG -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /opt/toolchains/crosstools-arm-gcc-5.3-linux-4.1-glibc-2.24-binutils-2.25/usr/lib/gcc/arm-buildroot-linux-gnueabi/5.3.0/include
...
@ 0 "" 2
	...
	.fnend
	.size	foo, .-foo
	.ident	"GCC: (Buildroot 2016.02) 5.3.0"
