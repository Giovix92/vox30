...
static bp_elem_t g_bcm963168mbv_30a[] = {
...
#if defined(DT_TEST)
  {bp_ulGpioOverlay,           .u.ul = BP_OVERLAY_PHY | BP_OVERLAY_SERIAL_LEDS},
#else
  {bp_ulGpioOverlay,           .u.ul = BP_OVERLAY_PHY | BP_OVERLAY_SERIAL_LEDS},
#endif
  {bp_usGpioLedAdsl,           .u.us = BP_SERIAL_GPIO_2_AL},
  {bp_usGpioLedAdslFail,       .u.us = BP_SERIAL_GPIO_3_AL},
  ...
  {bp_ulPhyId1,                .u.ul = 0x02},
  {bp_ulPhyId2,                .u.ul = 0x03},
  // config GPHY in 10/100M
  {bp_ulPhyId3,                .u.ul = 0x04 | ADVERTISE_ALL_MII | PHY_INTERNAL | PHY_INTEGRATED_VALID | PHY_ADV_CFG_VALID},
  {bp_ucDspType0,              .u.uc = BP_VOIP_DSP},
  {bp_ucDspAddress,            .u.uc = 0},
...
static bp_elem_t g_bcm963167ref3[] = {
    ...
    {bp_ulDeviceOptions,         .u.ul = (BP_DEVICE_OPTION_DISABLE_LED_INVERSION | BP_DEVICE_OPTION_ENABLE_GMAC)},
    {bp_ulGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                         BP_OVERLAY_USB_DEVICE )},
    {bp_usGpioLedSesWireless,    .u.us = BP_NOT_DEFINED},
    {bp_usGpioLedWanData,        .u.us = BP_NOT_DEFINED},
    ...
    {bp_usGpioLedBlPowerOn,      .u.us = BP_NOT_DEFINED},
    {bp_usGpioLedBlStop,         .u.us = BP_NOT_DEFINED},
    {bp_usGpioUart2Sdin,         .u.us = BP_GPIO_26_AH},
    {bp_usGpioUart2Sdout,        .u.us = BP_GPIO_27_AH},
    {bp_usAntInUseWireless,      .u.us = BP_WLAN_ANT_MAIN},
    {bp_usWirelessFlags,         .u.us = 0},
    ...
    {bp_ulPhyId3,                .u.ul = BP_PHY_ID_12 | PHY_INTERNAL | PHY_INTEGRATED_VALID }, // Gphy address is changed form 4 to 12
    ...
    {bp_ulPortMap,               .u.ul = 0x2e},
    {bp_ulPhyId1,                .u.ul = 0x01 | CONNECTED_TO_EXTERN_SW | PHY_INTEGRATED_VALID | PHY_EXTERNAL},
    {bp_ulPhyId2,                .u.ul = 0x02 | CONNECTED_TO_EXTERN_SW | PHY_INTEGRATED_VALID | PHY_EXTERNAL},
    {bp_ulPhyId3,                .u.ul = 0x03 | CONNECTED_TO_EXTERN_SW | PHY_INTEGRATED_VALID | PHY_EXTERNAL},
//    {bp_ulPhyId4,                .u.ul = 0x04 | CONNECTED_TO_EXTERN_SW | PHY_INTEGRATED_VALID | PHY_EXTERNAL},
//    {bp_ulPhyId4,                .u.ul = 0x04 | MAC_IF_RGMII},
    {bp_ulPhyId5,                .u.ul =  RGMII_DIRECT | CONNECTED_TO_EXTERN_SW },
    {bp_ucDspType0,              .u.uc = BP_VOIP_DSP},
    {bp_ucDspAddress,            .u.uc = 0},
    {bp_usGpioVoip1Led,          .u.us = BP_NOT_DEFINED},
    {bp_usGpioVoip2Led,          .u.us = BP_NOT_DEFINED},
...
#ifdef __SC_BUILD__ //DRV_Alex
#define BP_DDR_TEMP_SHIFT 16
#define BP_DDR_TEMP_EXTENDED_ASR (2 << BP_DDR_TEMP_SHIFT) /* Auto Self-Refresh Enable */
...
//  {bp_usGpioLedReserved,       .u.us = BP_GPIO_27_AL}, 
  ...
  {bp_usGpioLedReserved,       .u.us = BP_GPIO_116_AL}, 
  {bp_usGpioLedReserved,       .u.us = BP_GPIO_118_AH},   
  {bp_usGpioSfpDetect,         .u.us = BP_GPIO_37_AL},
#if 0 //DRV_Alex remove for DG400
  {bp_usGpioLedBlPowerOn,      .u.us = BP_GPIO_29_AL},
  {bp_usGpioLedBlStop,         .u.us = BP_GPIO_30_AL},
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0},
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},
  ...
  {bp_usGpioSecLedWanData,     .u.us = BP_GPIO_19_AL},
#endif
//  {bp_usDectRst,               .u.us = BP_GPIO_3_AL},
//  {bp_usGpioUart2Sdin,         .u.us = BP_GPIO_5_AH},
//  {bp_usGpioUart2Sdout,        .u.us = BP_GPIO_6_AH},
//  {bp_usDectRst,               .u.us = BP_GPIO_3_AL},
  {bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_CH0 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXA | BP_AFE_FE_REV_6303_REV_12_3_40 }, 
...
#endif
  {bp_ulPhyId0,                .u.ul = (BCM963138_PHY_BASE + 0x00) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
//  {bp_usSpeedLed100,           .u.us = BP_GPIO_101_AL},
//  {bp_usSpeedLed1000,          .u.us = BP_GPIO_100_AL},  
//  {bp_usLinkLed,               .u.us = BP_SERIAL_GPIO_10_AL},
  {bp_ulPhyId1,                .u.ul = (BCM963138_PHY_BASE + 0x01) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
//  {bp_usSpeedLed100,           .u.us = BP_GPIO_103_AL},
//  {bp_usSpeedLed1000,          .u.us = BP_GPIO_102_AL},  
//  {bp_usLinkLed,               .u.us = BP_SERIAL_GPIO_11_AL},
  {bp_ulPhyId2,                .u.ul = (BCM963138_PHY_BASE + 0x02) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
//  {bp_usSpeedLed100,           .u.us = BP_GPIO_105_AL},
//  {bp_usSpeedLed1000,          .u.us = BP_GPIO_104_AL},  
//  {bp_usLinkLed,               .u.us = BP_SERIAL_GPIO_12_AL},
  {bp_ulPhyId3,                .u.ul = BP_PHY_ID_NOT_SPECIFIED},
  {bp_ulCrossbar,              .u.ul = 13},
  {bp_ulCrossbarPhyId,         .u.ul = (BCM963138_PHY_BASE + 0x03) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
//  {bp_usSpeedLed100,           .u.us = BP_GPIO_107_AL},
//  {bp_usSpeedLed1000,          .u.us = BP_GPIO_106_AL},  
//  {bp_usLinkLed,               .u.us = BP_GPIO_13_AL},
#ifdef _SC_EMC_
  {bp_ulPhyId4,                .u.ul = BP_PHY_ID_NOT_SPECIFIED},
  {bp_ulCrossbar,              .u.ul = 10},
  {bp_ulCrossbarPhyId,         .u.ul = (BCM963138_PHY_BASE + 0x04) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
//  {bp_usSpeedLed100,           .u.us = BP_GPIO_109_AL},
//  {bp_usSpeedLed1000,          .u.us = BP_GPIO_108_AL},  
#endif
  {bp_ucDspType0,              .u.uc = BP_VOIP_DSP},
  {bp_ucDspAddress,            .u.uc = 0},
//  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_25_AL},
...
//  {bp_usGpioPotsLed,           .u.us = BP_SERIAL_GPIO_28_AL},
#ifdef VOX30_SFP
  {bp_ulMemoryConfig,          .u.ul = BP_DDR_TEMP_EXTENDED_ASR | BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_512MB| BP_DDR_DEVICE_WIDTH_16},
#else
  {bp_ulMemoryConfig,          .u.ul = BP_DDR_TEMP_EXTENDED_ASR | BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_256MB| BP_DDR_DEVICE_WIDTH_16},
#endif
  {bp_last}
};
...
bp_elem_t * g_BoardParms[] = {g_bcm963138sv, g_bcm963138dvt,  g_bcm963138ref, g_bcm963138ref_gfast_p40x, g_bcm963138ref_gfast_2,  g_bcm963138ref_gfast_p40x_mem, g_bcm963138ref_gfast_4,
    ...
    g_bcm963138ref_p502_bhr, g_bcm963138dvt_p300, g_bcm963138ref_rnc, g_bcm963138ref_rncp400, g_bcm963138ref_p502_moca_p200, g_bcm963138ref_p502_dual_moca_p200, g_bcm963138ref_3wlan, g_bcm963138ref_bgw, g_bcm963138rref_gfast, g_bcm963138rref_rnc, 0};
#endif
...
static bp_elem_t g_bcm963381ref1[] = {
  ...
  {bp_usGpioIntAFELDData,      .u.us = BP_GPIO_26_AH},
#ifdef __SC_BUILD__
  {bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_CH0 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXBJ | BP_AFE_FE_REV_6303_REV_12_3_50 },   
#else
  {bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_CH0 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXA | BP_AFE_FE_REV_6303_REV_12_3_50 },   
#endif
  {bp_ucDspType0,              .u.uc = BP_VOIP_DSP},
