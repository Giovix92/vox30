 ...
 */
#ifdef __SC_BUILD__
#define BLOG_TCPACK_IPV4_LEN   80   /* IPv4 total len value for pure TCP ACK  */
#else
#define BLOG_TCPACK_IPV4_LEN   64
#endif
...
#ifdef __SC_BUILD__
#define BLOG_TCPACK_XTM_PRIO    3
#define BLOG_TCPACK_ETH_PRIO    3
#else
