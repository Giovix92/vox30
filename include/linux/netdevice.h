...
#ifdef __SC_BUILD__
typedef enum {
	RS_IGNORE = 0, /*skip FON,VOIP and local*/
	RS_INCOMING = 1, /*from LAN/WLAN to WAN*/
	RS_OUTGOING = 2, /*from WAN to LAN/WLAN*/
}rs_route_type_t;
#endif 
/*
...
#ifdef __SC_BUILD__
typedef int(*nmap_lisen_in_kernel)(const struct sk_buff *skb, unsigned int protocol);
#endif
