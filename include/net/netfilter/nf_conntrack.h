...
struct nf_conn {
	...
	struct {
		...
		*/
         ...
         *    * +------+ +------+ +------+ +------+
         *     * 00000000  00000000 00000000  0000zyyx
         *      * +------+ +------+ +------+ +------+
         *       *
         ...
         *           * z    --- wlan session
         *            */
#define SC_NF_PKT_PRIO_MASK         0x00000006UL /*0000 0110*/
#define SC_NF_PKT_PRIO_BITS_SHIFT   (1)

#define SC_NF_PKT_FRAGMENT_FLAG     0x00000001UL    /*0000 0001*/ 
#define SC_NF_PKT_WLAN_SESSION      0x00000008UL    /*0000 0008*/ 


    unsigned int 		egress_mark;
    unsigned long sc_reserve;   /* sercomm reserve for some purpose */
    ...
    struct list_head icmp_bysrc_ip; /* used by icmp flood */
    struct icmp_bysrc_ip_s *icmp_head;      /* point to icmp private list head */
    struct list_head udp_bysrc_ip;  /* used by udp flood */
    struct udp_bysrc_ip_s *udp_head;        /* point to udp private list head */
