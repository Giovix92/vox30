...
#define CAL_FORWARD_IP_MAX_CHAR     64
...
typedef struct
{
    ...
    char stroute[CAL_FORWARD_TMP_MAX_CHAR];
...
{
    char key[CAL_FORWARD_TMP_MAX_CHAR];
    char oif[CAL_FORWARD_TMP_MAX_CHAR];
    char enable[CAL_FORWARD_TMP_MAX_CHAR];
    char stroute[CAL_FORWARD_TMP_MAX_CHAR];
    char dstip[CAL_FORWARD_IP_MAX_CHAR];
    char dstmask[CAL_FORWARD_IP_MAX_CHAR];
...
int cal_dr_add_one_virtual_entry(cal_dynamic_route* entry);
...
//int cal_dr_del_one_virtual_entry(cal_static_routing* entry);
int cal_dr_del_one_virtual_entry(int index);
...
int cal_pf_set_default_con_service(char *value);
char *cal_pf_get_default_con_service(void);
