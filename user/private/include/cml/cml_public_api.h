...
char* cm_factory_value_get(const char *format, ...);
int cm_factory_value_set(const char *format, ...);
char* cm_attribute_value_get(const char *format, ...);
...
/****************************************************************************
 * Function name : cm_parameter_hidden
 *
 * Description:
 * 1. get value of this uri will not check its hidden attribute
 * 2. set value of this uri will not check its hidden attribute
 * 3. hidden this parameter when get node which this uri belongs to
 * 4. commit action will not check hidden attribute
 *
 * Return: 
 *     0(success) or other value
 ****************************************************************************/
int cm_parameter_hidden(const char *format, ...);
...
int cm_instance_del_all(char *uri);
int cm_instance_del_sort(int index, const char *format, ...);
int cm_node_del(const char *format, ...);
...
int cm_config_import(char *file_in, char *url_list);
int cm_config_default(void);
int cm_config_soft_reset(void);
int cm_partial_config_default(char *uri);
int cm_is_ready(void);
