...
#ifdef VFIE
#define SC_ADMINCONFIG_MTD_PATH       ("/mnt/1/admin")
#define SC_USERCONFIG_MTD_PATH       ("/mnt/1/user")
#define SC_SUPCONFIG_MTD_PATH       ("/mnt/1/support")
#else
#define SC_ADMINCONFIG_MTD_PATH       ("/mnt/0/admin")
#define SC_USERCONFIG_MTD_PATH       ("/mnt/0/user")
#define SC_SUPCONFIG_MTD_PATH       ("/mnt/0/support")
#endif
#else
#define SC_XMLCONFIG_MTD_PATH       ("/mnt/0/xmlx")
#endif
...
#ifdef MULTI_LEVEL_CONFIG    
#define SC_ADMINCONFIG_MTD_PATH       ("/mnt/0/adminx")
#define SC_USERCONFIG_MTD_PATH       ("/mnt/0/userx")
#define SC_SUPCONFIG_MTD_PATH       ("/mnt/0/supportx")
#else
#define SC_XMLCONFIG_MTD_PATH       ("/mnt/0/xmlx")
#endif
...
#define SC_FW_IMG_UBI_FILE			"/mnt/0/fw_info"
...
int util_get_running_flags(int *flags, int size);
