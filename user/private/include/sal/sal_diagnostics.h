...
char* sal_diag_get_tcpdump_complete(void);
int sal_diag_set_tcpdump_complete(char* value);
char* sal_diag_get_tcpdump_schedule(void);
int sal_diag_set_tcpdump_schedule(char* value);
...
char *sal_diag_get_tcpdump_start(void);
int sal_diag_set_tcpdump_start(char *value);
...
char *sal_diag_get_hw_timestamp(void);
int sal_diag_set_hw_timestamp(char *value);
#endif
