...
#include "memdebug.h"
#ifdef __SC_BUILD__
extern unsigned int max_session_num;
extern unsigned int tb_test_duration;
extern unsigned int tb_test_minterval;
extern unsigned int tb_test_moffset;
char *interface = NULL;;
#endif
...
#ifdef __SC_BUILD__
    data->set.tcp_windowsize = 0;
    data->set.tcp_nocopy = 0;
    data->set.tcp_nocopy_len = 0;
#endif
                     ...
                     va_list param)
{
...
#ifdef __SC_BUILD__
  case CURLOPT_TCP_USER_TIMEOUT:
    data->set.tcp_user_timeout = va_arg(param, long);
    break;

  case CURLOPT_TCP_SYN_RETRY:
    data->set.tcp_syn_retry = va_arg(param, long);
    break;
#endif
  ...
  case CURLOPT_TCP_NODELAY:
    ...
    break;
#ifdef __SC_BUILD__
  case CURLOPT_TCP_RES:
    data->set.tcp_res = (0 != va_arg(param, long))?TRUE:FALSE;
    break;
  case CURLOPT_TCP_COUNT:
    data->set.tcp_count = (0 != va_arg(param, long))?TRUE:FALSE;
    break;
  case CURLOPT_TCP_NOCOPY:
    data->set.tcp_nocopy = (0 != va_arg(param, long))?TRUE:FALSE;
    break;
  case CURLOPT_TCP_WINDOWSIZE:
    /*
     * Set Max TCP_WINDOWSIZE
     */
    data->set.tcp_windowsize = va_arg(param, long);
    break;
#endif
  ...
  case CURLOPT_TOS:
    data->set.tos = va_arg(param, int);
    break;
#endif
#if defined(HAVE_ETHERNET_PRIORITY_OPT)
  case CURLOPT_ETHERNET_PRIORITY:
    data->set.eth_priority = va_arg(param, int);
    break;
#endif
  case CURLOPT_SESSION_IDX:
    data->set.session_idx = va_arg(param, int);
    break;
  case CURLOPT_MAX_SESSION_NUM:
    max_session_num = va_arg(param, int);
    break;
  case CURLOPT_TB_TEST_DURATION:
    tb_test_duration = va_arg(param, int);
    break;
  case CURLOPT_TB_TEST_MINTERVAL:
    tb_test_minterval = va_arg(param, int);
    break;
  case CURLOPT_TB_TEST_MOFFSET:
    tb_test_moffset = va_arg(param, int);
    break;
#endif
