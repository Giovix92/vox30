...
struct Progress {
  ...
  double t_connect;
#ifdef __SC_BUILD__
  struct timeval t_rom;
  struct timeval t_bom;
  struct timeval t_eom;
  double total_bs; /*for TotalBytesSent of PerConnectionResult*/
  double total_br; /*for TotalBytesReceived of PerConnectionResultn*/
  long timeUp;
  struct timeval t_request;
  struct timeval t_response;
#endif
  double t_appconnect;
