...
#ifdef __SC_BUILD__
  {"curl_time_rom", CURLINFO_ROM_TIME, writeenv_DOUBLE},
  {"curl_time_request", CURLINFO_REQUEST_TIME, writeenv_DOUBLE},
  {"curl_time_response", CURLINFO_RESPONSE_TIME, writeenv_DOUBLE},
#endif
