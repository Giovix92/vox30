...
IF_BASENAME(APPLET_NOFORK(basename, basename, _BB_DIR_BIN, _BB_SUID_DROP, basename))
...
IF_READLINK(APPLET(readlink, _BB_DIR_BIN, _BB_SUID_DROP))
...
IF_WHICH(APPLET(which, _BB_DIR_BIN, _BB_SUID_DROP))
