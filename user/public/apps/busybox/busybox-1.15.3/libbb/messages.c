...
#define BB_ADDITIONAL_PATH ":/mnt/rootfs/bin"
#endif

#ifndef BB_ADDITIONAL_LIB_PATH
#ifdef CONFIG_SUPPORT_PLUME
#define BB_ADDITIONAL_LIB_PATH ":/mnt/rootfs/lib:/usr/plume/lib"
#else
#define BB_ADDITIONAL_LIB_PATH ":/mnt/rootfs/lib"
#endif
#endif
...
const char bb_LIB_PATH_root_path[] ALIGN1 =
	"LD_LIBRARY_PATH=/usr/lib:/lib" BB_ADDITIONAL_LIB_PATH;
