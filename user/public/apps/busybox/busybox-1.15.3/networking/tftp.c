...
/* VOX30_SFP tftp backed-off retries = 24*/
#define TFTP_NUM_RETRIES            24  /* number of backed-off retries */
...
#ifdef __SC_BUILD__
#ifdef CONFIG_SUPPORT_5G_QD
    if(local_file && strcmp(local_file,"topaz-linux.lzma.img") == 0)
    {
        system("/usr/sbin/qinit &");
    }
#endif
#endif
	return result;
