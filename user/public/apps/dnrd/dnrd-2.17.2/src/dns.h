...
#define MASK_NO_SUCH_NAME  0x0003
#ifndef SCM_BINDING
#define MASK_Z      0x0070
#else
/*
 * martin_huang@sdc.sercomm.com: we do not check non-authenticated date bit
 * non-authenticated date bit should be valid for some dns server
 *
 * */
