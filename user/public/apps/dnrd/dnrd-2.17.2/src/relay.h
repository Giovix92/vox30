...
int handle_query(const struct sockaddr_in6 *fromaddrp, char *msg, int *len, domnode_t **dptr, int dtype);
#else
int handle_query(const struct sockaddr_in *fromaddrp, char *msg, int *len, domnode_t **dptr, int dtype);
#endif
#else
