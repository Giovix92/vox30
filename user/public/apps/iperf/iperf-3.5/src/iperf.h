...
struct iperf_interval_results
{
    ...
    int pmtu;
#ifdef __SC_BUILD__
    iperf_size_t bytes_bg_rx;
    iperf_size_t bytes_bg_tx;
#endif
};
...
#ifdef __SC_BUILD__
struct sc_iperf_stream_setting
{
...
#ifdef __SC_BUILD__
    int cm_instance_id;
    if_adv_info_t if_stats_start;
    if_adv_info_t if_stats_end;
#endif
...
#ifdef __SC_BUILD__
    struct sc_iperf_stream_setting *iperf_stream_setting;
#endif
