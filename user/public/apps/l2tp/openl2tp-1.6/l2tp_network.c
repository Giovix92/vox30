...
{
#define L2TP_DSCP 0x0
	unsigned char service_type = L2TP_DSCP << 2;
    struct sockaddr_in saddr;
    ...
    (void) setsockopt(new_fd, SOL_IP, IP_TOS, (char *)&service_type, sizeof(service_type));
