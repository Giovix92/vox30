...
#endif /* L2TP_TEST */
#ifdef __SC_BUILD__
// this must be cohered with the same struct defined in l2tp_plugin
#define  L2TP_CONFIG_PROC_NAME "/proc/l2tp_plugin_config"
#define WAN_DEV_NAME  "eth2.2"
#define  IF_NAME_SIZE   16  // IFNAMSIZ is 16 in S1000
#define  ETH_ADDR_LEN    6  // ETH_ALEN is 6 in s1000
typedef unsigned int __u32;
typedef unsigned short __u16;
struct l2tp_user_info{
    __u32 type;                         // 1:set, 0:clear
    char wan_dev_name[IF_NAME_SIZE];
    char ppp_dev_name[IF_NAME_SIZE];
    __u32 daddr;
    __u32 saddr;
    __u16 tid;
    __u16 cid;
...
//static void write_config_to_proc_l2tp(struct l2tp_tunnel *t, struct l2tp_session *c, __u32 type);
#endif
