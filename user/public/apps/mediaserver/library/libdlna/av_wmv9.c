...
static wmv9_profile_t wmv9_profile_simple_low[] = {
  { 176, 144, 15, 1, 96*KBPS}
};

static wmv9_profile_t wmv9_profile_simple_medium[] = {
  { 240, 176, 30, 1, 384*KBPS},
  { 240, 176, 30000, 1001, 384*KBPS},
  { 352, 288, 15, 1, 384*KBPS}
};

static wmv9_profile_t wmv9_profile_main_medium[] = {
  { 720, 480, 30, 1, 10*MBPS},
  { 720, 480, 30000, 1001, 10*MBPS},
  { 720, 576, 25, 1, 10*MBPS}
};

static wmv9_profile_t wmv9_profile_main_high[] = {
  { 1920, 1080, 30, 1, 20*MBPS},
  { 1920, 1080, 30000, 1001, 20*MBPS}
};
