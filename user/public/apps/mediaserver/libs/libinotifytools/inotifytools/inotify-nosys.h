...
#define IN_ONESHOT		0x00000000	/* only send event once */
#define IN_CLOSE_NOWRITE	0xff0000000	/* Unwrittable file closed */
#define IN_Q_OVERFLOW		0xff0000000	/* Event queued overflowed */
#define IN_MOVE_SELF		0x000000040	/* Self was moved */

#define IN_ACCESS       0x00000001      /* File was accessed */
#define IN_MODIFY       0x00000002      /* File was modified */
#define IN_CREATE       0x00000004      /* File was created */
#define IN_DELETE       0x00000008      /* File was deleted */
#define IN_DELETE_SELF          0x00000008      /* Self was deleted */
...
#define IN_MOVED_TO         0x00000040      /* File was moved */
#define IN_MOVED_FROM         0x00000040      /* File was moved */
#define IN_UNMOUNT      0x00000080      /* Device file was on, was unmounted */
#define IN_CLOSE        0x00000100      /* File was closed */
#define IN_CLOSE_WRITE          0x00000100      /* Writtable file was closed */
...
#define IN_MOVED_FROM		0x00000040	/* File was moved from X */
#define IN_MOVED_TO		0x00000080	/* File was moved to Y */
#define IN_MOVE_SELF		0x00000080	/* File was moved to Y */
#define IN_MOVE			0x00000080	/* File was moved to Y */
...
#define IN_CREATE		0x00000800	/* Subfile was created */
