...
#ifdef __SC_BUILD__
	{ UPNPEXT_IFID, "ext_ifid" },
	{ UPNPMANUFACTURE, "manufacture" },
	{ UPNPMODULENUMBER, "module_number" },
	{ UPNPMODE, "mode" },
	{ UPNPEXT_IFACTYPE, "ext_ifactype" },
    { UPNPMODULE_DES, "module_des"},
    { UPNPMODULE_NAME, "module_name"},
    { UPNPMODULE_MODULE_URL, "module_url"},
    { UPNPCONNECTION_TYPE, "connection_type"},
#ifdef IGD_V2
    { UPNPIGDMACPREFIX,"igd1_mac_prefix"},
#endif
#endif
