...
#if __SC_BUILD__ 
	{"/manufacturer", manufacture},		/* required */
/* 8 */
	{"/manufacturerURL", module_url},	/* optional */
	{"/modelDescription", module_des}, /* recommended */
	{"/modelName", module_name},	/* required */
	{"/modelNumber", module_number},
	{"/modelURL", module_url},
#else
...
/* 19 */
	...
	{"/manufacturerURL", module_url},
	{"/modelDescription" , module_des},
...
#ifdef __SC_BUILD__
#ifdef IGD_V2
//only support for IGD1
static const struct XMLElt rootDesc_camera[] =
{
/* 0 */
	{root_device, INITHELPER(1,2)},
	{"specVersion", INITHELPER(3,2)},
...
/* 53 */
	...
	{"/serviceId", "urn:upnp-org:serviceIdConn1"},
	{"/controlURL", WANIPC_CONTROLURL},
	{"/eventSubURL", WANIPC_EVENTURL},
	{"/SCPDURL", WANIPC_PATH},
#ifdef ENABLE_6FC_SERVICE
...
#ifdef __SC_BUILD__
#ifdef IGD_V2
static const struct action WANIPCnActions_camera[] =
{
	{"SetConnectionType", SetConnectionTypeArgs}, /* R */
	{"GetConnectionTypeInfo", GetConnectionTypeInfoArgs}, /* R */
	{"RequestConnection", 0}, /* R */
...
#ifdef __SC_BUILD__
#ifdef IGD_V2
static const struct stateVar WANIPCnVars_camera[] =
{
/* 0 */
#if 0
	{"ConnectionType", 0, 0/*1*/}, /* required */
...
#ifdef __SC_BUILD__
#ifdef IGD_V2
static const struct serviceDesc scpdWANIPCn_camera =
{ WANIPCnActions_camera, WANIPCnVars_camera };
#endif
#endif
/* WANCfg.xml */
...
genRootDesc_camera(int * len)
{
	...
	* len = strlen(xmlver);
	/*strcpy(str, xmlver); */
	memcpy(str, xmlver, *len + 1);
	str = genXML(str, len, &tmplen, rootDesc_camera);
	str[*len] = '\0';
	return str;
}
#endif
...
#ifdef IGD_V2
static char *
genServiceDesc_camera(int * len, const struct serviceDesc * s)
{
	int i, j;
	const struct action * acts;
	const struct stateVar * vars;
...
#ifdef IGD_V2
char *
genWANIPCn_camera(int * len)
{
    return genServiceDesc_camera(len,&scpdWANIPCn_camera);
}
#endif
#endif
/* genWANCfg() :
