...
extern int ext_ifid;
extern char manufacture[];
extern char module_number[];
extern char device_name[];
extern int upnp_mode;
extern char ext_if_actype[];
extern char module_des[];
extern char module_name[];
extern char module_url[];
extern char connectionType[];
#ifdef IGD_V2
extern char igd1_mac_prefix[];
#endif
#endif
...
extern int enable_pcpd;
#endif

#ifdef __SC_BUILD__
#ifdef IGD_V2
#define DEVICE_ARRAY_SIZE 256
struct mac_ip_addr {
    struct in_addr ip_addr;
    char mac_addr[18] ;
};
extern struct mac_ip_addr devicearray[DEVICE_ARRAY_SIZE];
