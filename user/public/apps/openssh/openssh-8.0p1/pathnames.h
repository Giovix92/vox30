...
#ifdef __SC_BUILD__
#define SSH_CONFIG_DIR	"/var/ssh"
#define SSH_HOST_PASSWOED_FILE	"/var/ssh/password.conf"
#endif
/*
 ...
 */
#ifdef __SC_BUILD__
#define _PATH_SSH_SYSTEM_HOSTFILE	SSH_CONFIG_DIR "/ssh_known_hosts"
#define _PATH_SSH_SYSTEM_HOSTFILE2	SSH_CONFIG_DIR "/ssh_known_hosts2"
#else
...
#ifdef __SC_BUILD__
#define _PATH_SSH_PROGRAM		"/usr/sbin/ssh"
#else
 ...
 */
#ifdef __SC_BUILD__
#define _PATH_SSH_USER_DIR		SSH_CONFIG_DIR "/.ssh"
#else
 ...
 */
#ifdef __SC_BUILD__
#define _PATH_SSH_USER_HOSTFILE		SSH_CONFIG_DIR "/.ssh/known_hosts"//may be need to change this accoding to user
#else
#define _PATH_SSH_USER_HOSTFILE		"~/" _PATH_SSH_USER_DIR "/known_hosts"
#endif
/* backward compat for protocol 2 */
#ifdef __SC_BUILD__
#define _PATH_SSH_USER_HOSTFILE2	SSH_CONFIG_DIR "/.ssh/known_hosts2"//may be need to change this accoding to user
#else
...
#ifdef __SC_BUILD__
#define _PATH_SSH_KEY_SIGN		"/usr/sbin/ssh-keysign"
#else
