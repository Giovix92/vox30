...
#ifdef __SC_BUILD__
#define MAX_PADI_ATTEMPTS 7
#define MAX_PADR_ATTEMPTS 4
#else
...
typedef struct PPPoEConnectionStruct {
    ...
    PPPoETag hurl;		    /* hurl */
    PPPoETag motm;		    /* motm */
    PPPoETag ipRouteAdd;	/* iprouteadd */
#endif
...
#ifdef __SC_BUILD__
void sendPADTFromClientForMultiBras(PPPoEConnection *conn, unsigned char *dmac);
#endif
...
#if (defined(__SC_BUILD__) && defined(CONFIG_PPP_SUPPORT_PADM_PADN))
void waitForPADMandPADN(PPPoEConnection *conn, int timeout);
#endif
