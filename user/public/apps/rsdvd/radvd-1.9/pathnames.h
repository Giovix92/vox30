...
#define PATH_RADVD_CONF "/etc/rsdvd.conf"
#endif

#ifndef PATH_RADVD_DEPRECATE_CONF
#define PATH_RADVD_DEPRECATE_CONF "/etc/rsdvd_deprecate.conf"
#endif

#ifndef PATH_RADVD_PID
#define PATH_RADVD_PID "/var/run/rsdvd.pid"
#endif

#ifndef PATH_RADVD_LOG
#define PATH_RADVD_LOG "/var/log/rsdvd.log"
#endif
