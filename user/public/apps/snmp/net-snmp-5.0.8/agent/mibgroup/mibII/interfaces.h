 ...
 */
     ...
     struct ifnet {
         ...
         u_long          if_ipackets;   /* unicast packets received on interface */
         ...
         u_long          if_opackets;   /* unicast packets sent on interface */
#ifdef __SC_BUILD__
         u_long          if_inupackets;   /* non-unicast packets received on interface */
         u_long          if_onupackets;   /* non-unicast packets sent on interface */
#endif
