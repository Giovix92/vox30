...
#ifdef __SC_BUILD__
  { "ftp_remote_access_enable", &tunable_ftp_remote_access_enable},
  { "sftp_remote_access_enable", &tunable_sftp_remote_access_enable},
  { "guest_world_readable_only", &tunable_guest_world_readable_only},
#endif
  { 0, 0 }
};
...
parseconf_str_array[] =
{
...
#ifdef __SC_BUILD__
  { "ftp_remote_access_users",  &tunable_ftp_remote_access_users },
  { "sftp_remote_access_users", &tunable_sftp_remote_access_users },
  { "ftp_server_address", &tunable_ftp_server_address },
  { "ftp_server_mask", &tunable_ftp_server_mask },
  { "ftp_server_wan_address", &tunable_ftp_server_wan_address },
  { "ftp_local_access_users",  &tunable_ftp_local_access_users },
  { "sftp_local_access_users", &tunable_sftp_local_access_users },
  { "pid_file", &tunable_pid_file },
  { "remote_local_root", &tunable_remote_local_root },
  ...
  { "ftp_vpn_remote_address", &tunable_vpn_remote_address},
  { "ftp_vpn_mask",&tunable_vpn_mask},
#endif
#endif
  { 0, 0 }
};
