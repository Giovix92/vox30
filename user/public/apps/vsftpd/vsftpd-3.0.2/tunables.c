...
#ifdef __SC_BUILD__
int tunable_ftp_remote_access_enable;
int tunable_sftp_remote_access_enable;
int tunable_ftp_local_access_enable;
int tunable_sftp_local_access_enable;
int tunable_guest_world_readable_only;
const char* tunable_ftp_remote_access_users;
const char* tunable_sftp_remote_access_users;
const char* tunable_ftp_local_access_users;
const char* tunable_sftp_local_access_users;
const char* tunable_ftp_server_address;
const char* tunable_ftp_server_wan_address;
const char* tunable_ftp_server_mask;
const char* tunable_pid_file;
const char* tunable_remote_local_root;
int tunable_is_remote_login = 0;
...
const char* tunable_vpn_remote_address;
const char* tunable_vpn_mask;
#endif
#endif
...
tunables_load_defaults()
{
  ...
  tunable_ftp_remote_access_enable = 0;
  tunable_sftp_remote_access_enable = 0;
  tunable_ftp_local_access_enable = 1;
  tunable_sftp_local_access_enable = 1;
  tunable_guest_world_readable_only = 1;
#endif
...
#ifdef __SC_BUILD__
  install_str_setting("/var/share/empty", &tunable_secure_chroot_dir);
#else
...
#ifdef __SC_BUILD__
  install_str_setting("/var/.message", &tunable_message_file);
#else
...
#ifdef __SC_BUILD__
  install_str_setting("/var/vsftpd.banned_emails", &tunable_banned_email_file);
  install_str_setting("/var/vsftpd.chroot_list", &tunable_chroot_list_file);
#else
...
#ifdef __SC_BUILD__
  install_str_setting("/var/vsftpd.user_list", &tunable_userlist_file);
#else
...
#ifdef __SC_BUILD__
  install_str_setting("/var/vsftpd.email_passwords",
                      &tunable_email_password_file);
  install_str_setting("/var/share/ssl/certs/vsftpd.pem",
                      &tunable_rsa_cert_file);
  install_str_setting(0, &tunable_remote_local_root);
#else
...
#ifdef __SC_BUILD__
  install_str_setting(0, &tunable_ftp_server_wan_address);
  install_str_setting(0, &tunable_ftp_remote_access_users);
  install_str_setting(0, &tunable_sftp_remote_access_users);
  install_str_setting(0, &tunable_ftp_local_access_users);
  install_str_setting(0, &tunable_sftp_local_access_users);
  install_str_setting(0, &tunable_ftp_server_address);
  install_str_setting(0, &tunable_ftp_server_mask);
#if defined(CONFIG_SUPPORT_L2TP_CLIENT) || defined(CONFIG_SUPPORT_IPSEC_CLIENT)||defined(CONFIG_SUPPORT_L2TP_SERVER)||defined(CONFIG_SUPPORT_PPTP_CLIENT) || defined(CONFIG_SUPPORT_PPTP_SERVER)
  install_str_setting(0, &tunable_vpn_remote_address);
  install_str_setting(0, &tunable_vpn_mask);
#endif
  install_str_setting("/tmp/ftp/vsftpd.pid", &tunable_pid_file);
#endif
