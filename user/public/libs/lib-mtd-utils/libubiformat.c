...
static int sc_getopt(int init, int argc, char *argv[])
{
    int key = -1;
    static int i = 2;//skip cmd name and mtd info parameter
...
static int parse_opt(int argc, char * const argv[])
{
	...
	args.node = argv[1];//argv[0]: cmd name, argv[1]: mtd info
